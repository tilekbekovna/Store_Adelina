...
class UserProfile(Base):
    ...
    status: Mapped[StatusChoices] = mapped_column(Enum(StatusChoices, name="statuschoices"),default=StatusChoices.simple)
...
class Product(Base):
    ...
    # many-to-one жакта delete-orphan жок!
    ...
    product_reviews: Mapped[List['Review']] = relationship(
        "Review", back_populates='product_rev', cascade='all, delete-orphan'
    )
